...
class GUICredits(object):
    def __init__(self):
        ...
        try:
            ...
            self.titleLabel = Label(master=self.masterFrame, textvariable=self.title, fg='#00a6ff', bg='#707070',
                                    font="fixedsys 36 bold")
            self.descriptionLabel = Label(master=self.masterFrame, textvariable=self.description, fg='#00a6ff',
                                          bg='#707070',
                                          font="fixedsys 26 bold")
            self.exitTextLabel = Label(master=self.masterFrame, text='Drücke "Enter" zum überspringen!', fg='#00a6ff',
                                       bg='#707070',
